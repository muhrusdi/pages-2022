        ...
        <div className="flex mt-6">
          <div className="w-60 flex-none">
            <div>
              <input
                type="text"
                className="bg-blueGray-900 rounded-md w-full px-4 py-3"
                placeholder="Search"
              />
            </div>
          ...
          <div className="sm:px-14">
            <div>
              ...
              <h4 className="text-xl leading-relaxed mt-6">
                ...
                reiciendis tenetur doloremque eligendi.
              </h4>
            </div>
            <ArticleStyled className="prose prose-lg mt-8">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore
                reiciendis tenetur doloremque eligendi. Nemo commodi obcaecati
                mollitia recusandae voluptate deserunt ab est quas officiis!
                Fugit culpa quae placeat corrupti iure?
              </p>
            </ArticleStyled>
          </div>
        </div>
